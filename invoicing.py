#The purpose of this project is to show the total invoice amount for furniture purchases. Each piece of furniture will be saved as a variable and will have a dollar amount assigned to it.

#Lovely Loveseat
lovely_loveseat_description = """
Lovely Loveseat. Tufted polyester blend on wood. 32 
inches high x 40 inches wide x 30 inches deep. Red
or white. """
...
#Sales tax to be added to each order
sales_tax = .088
#END OF DATA
